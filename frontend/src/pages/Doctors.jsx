...
const Doctors = () => {
  const { speciality } = useParams(); // Imp
  ...
  return (
    <div className="mt-4">
      ...
      <div className="flex flex-col sm:flex-row items-start gap-5 mt-5">
        <button className={`py-1 px-3 border rounded text-sm transition-all sm:hidden ${showFilter ? 'bg-primary text-white': ''}`} onClick={()=>setShowFilter(pre=>!pre)}>Filter</button>
